...
@Component({
  ...
  imports: [],
  template: `
    <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 346" [attr.width]="size?.width" [attr.height]="size?.height">
